      ...
      <header className={styles.header}>
        ...
        <nav className={styles.nav__container}>
          <ul className={styles.nav__list}>
            ...
            <li onMouseEnter={textEnter} onMouseLeave={textLeave}>Blogs</li>
            <li onMouseEnter={textEnter} onMouseLeave={textLeave}>Contect</li>
            <li onMouseEnter={textEnter} onMouseLeave={textLeave}>Github</li>
          </ul>
        </nav>
      </header>
    </>
